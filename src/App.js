  ...
  return (
    <div style={{ minHeight: "100vh", background: "#020817", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ textAlign: "center", maxWidth: 360, width: "100%", padding: "0 24px" }}>
        <div style={{ fontSize: 9, letterSpacing: 4, color: "#f59e0b", fontWeight: 700, marginBottom: 10 }}>EXOTIC ARBITRAGE INTELLIGENCE</div>
        <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 32, color: "#f8fafc", marginBottom: 8 }}>European Scout</div>
        ...
        <input
          ...
          autoFocus
          style={{ width: "100%", padding: "12px 16px", background: "#0f172a", border: `1px solid ${error ? "#ef4444" : "#1e293b"}`, borderRadius: 8, color: "#f1f5f9", fontSize: 14, outline: "none", fontFamily: "'Inter', sans-serif", boxSizing: "border-box", marginBottom: 8 }}
        />
        {error && <div style={{ fontSize: 12, color: "#ef4444", marginBottom: 8 }}>Incorrect password</div>}
        <button onClick={tryUnlock} disabled={!pw.trim()}
          style={{ width: "100%", padding: "12px", background: pw.trim() ? "linear-gradient(135deg, #b45309, #f59e0b)" : "#1e293b", border: "none", borderRadius: 8, color: pw.trim() ? "#fff" : "#475569", fontSize: 13, fontWeight: 700, cursor: pw.trim() ? "pointer" : "not-allowed" }}>
          Enter →
        </button>
      </div>
    </div>
...
4. Assess whether a genuine arbitrage opportunity exists
...
Return ONLY a JSON object, no markdown, no explanation:
{
  ...
  "comparable_sales": [
    ...
    try {
      ...
      if (resp.status === 401) { setPassword(null); return; }
        ...
        <div style={{ maxWidth: 860, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
          ...
          <div style={{ display: "flex", gap: 20, alignItems: "center" }}>
            ...
            <button onClick={() => setPassword(null)}
              style={{ padding: "4px 10px", background: "none", border: "1px solid #1e293b", borderRadius: 6, color: "#475569", fontSize: 10, cursor: "pointer" }}>
              Lock
            </button>
          </div>
        </div>
